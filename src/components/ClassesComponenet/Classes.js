            ...
            <div className="item">  
                ...
                <div className="our-content-div">
                    ...
                    <div className="our-content-full">
                        <h4><a href="">How to learn photography in an efficient way</a> </h4>
                    </div>

                    <div className="our-content-left">
                        <div className="thumb-img">
                        <a href="#" className="link">
                            <img src={props.img} className="img-fluid user" alt="user" />
                        </a>
                        </div>
                    </div>
                    <div className="our-content-right">
                        <h3><a href="#" className="link">Mike Visuals <span className="icon-rounded-span check-icon-rounded">
                            <span className="material-icons">done</span></span> </a></h3> <p>Visual Expert</p>
                    </div>
                    </div>
