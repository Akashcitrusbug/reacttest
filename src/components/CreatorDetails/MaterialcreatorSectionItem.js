        ...
        <div className="item">
            <div className="materials-creators-slider-box">
                ...
                <div className="creators-img-mask-thumb">
                    <div className="img-thumb"> <img src={props.materialbycreatordata.img} className="img-fluid img-responsive" alt="image" /> </div>
                </div>
                </a>
                <div className="creators-content-div">
                <h3><a href="#" className="link">{props.materialbycreatordata.name}</a></h3>
                </div>
            </div>
        </div>
