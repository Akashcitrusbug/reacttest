      ...
      <div class="testimonials-card-box">
        <div class="testimonials-card-inner">
          <div class="user-top-row">
            <div class="img-thumb"> <img src={props.data.img} class="img-fluid img-responsive" alt="testimonials" /> </div>
            <div class="text-content-div">
              <h3><a href="#" class="link">{props.data.name}</a></h3>
